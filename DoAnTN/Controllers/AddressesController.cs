...
namespace DoAnTN.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            var shopDienThoaiContext = _context.Addresses.Where(a => a.UserId == id);
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,FirstName,LastName,Phone,City,District,Address1,Status,IsDelete,IsDisplay,LastUpdate")] Address address)
        {
