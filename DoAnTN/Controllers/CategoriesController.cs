...
namespace DoAnTN.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,IsDelete,IsDisplay,LastUpdate")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsDelete,IsDisplay,LastUpdate")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
